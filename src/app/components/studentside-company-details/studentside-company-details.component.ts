...
@Component({
  selector: 'app-studentside-company-details',
  templateUrl: './studentside-company-details.component.html',
  styleUrls: ['./studentside-company-details.component.css']
})
export class StudentsideCompanyDetailsComponent implements OnInit {
